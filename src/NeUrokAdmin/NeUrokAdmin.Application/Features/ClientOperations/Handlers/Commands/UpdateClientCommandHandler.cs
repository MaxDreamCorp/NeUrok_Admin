...
namespace NeUrokAdmin.Application.Features.ClientOperations.Handlers.Commands
{
    public class UpdateClientCommandHandler : IRequestHandler<UpdateClientCommand>
    {
        ...
        public UpdateClientCommandHandler(IClientRepository clientRepository, IClientStatusRepository clientStatusRepository, ICourseRepository courseRepository)
        {
